      ...
      <header className="site-header">
        <div className="container site-header__inner">
          <NavLink to="/" className="site-brand">
            <span className="site-brand__eyebrow">{siteConfig.concept}</span>
            <span className="site-brand__name">{siteConfig.brand}</span>
          </NavLink>
          ...
          <a className="site-header__cta" href={siteConfig.contact.reservationsUrl} target="_blank" rel="noreferrer">
            Reservar mesa
          </a>
        </div>
      </header>
